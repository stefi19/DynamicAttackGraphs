...
path. This provenance is currently reconstructed from the final base and derived
fact sets rather than maintained inside Differential Dataflow itself.
...
final base and derived fact sets. It can explain one valid proof for a fact such
as \texttt{goalReached}, but it does not enumerate all proofs, all minimal
attack paths, or all changed explanations after an update. Finally, all
